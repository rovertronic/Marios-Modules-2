...
u32 sMarioCharacterSoundTable[][2] = {
    ...
    [MARIO_SND_HERE_WE_GO]           = { SOUND_MARIO_HERE_WE_GO,          SOUND_GIRL_HEREWEGO },
    ...
    [MARIO_SND_WAAAOOOW]             = { SOUND_MARIO_WAAAOOOW,            SOUND_GIRL_AIEE },
    ...
    [MARIO_SND_ON_FIRE]              = { SOUND_MARIO_ON_FIRE,             SOUND_GIRL_AIEE },
